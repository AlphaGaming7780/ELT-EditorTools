...
// 			AddBinding(showUnTestedObject = new GetterValueBinding<bool>("elt_netTool", "showuntestedobject", () => Network.network.ExtensionSettings.ShowUnTestedObject));
// 			AddBinding(new TriggerBinding<bool>("elt_netTool", "showuntestedobject", new Action<bool>(ShowUnTestedObject)));
